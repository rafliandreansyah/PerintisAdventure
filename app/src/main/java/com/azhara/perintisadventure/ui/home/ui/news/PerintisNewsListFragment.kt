 ...
 * Use the [PerintisNewsListFragment.newInstance] factory method to
...
class PerintisNewsListFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PerintisNewsListFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PerintisNewsListFragment().apply {
