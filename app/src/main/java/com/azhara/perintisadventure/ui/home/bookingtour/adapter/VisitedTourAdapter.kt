package com.azhara.perintisadventure.ui.home.bookingtour.adapter
...
class VisitedTourAdapter(private val visitedTour: List<String>) :
    RecyclerView.Adapter<VisitedTourAdapter.VisitedTourViewHolder>() {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): VisitedTourAdapter.VisitedTourViewHolder {
        return VisitedTourViewHolder(
            LayoutInflater.from(parent.context)
                .inflate(R.layout.rv_item_visited_tour, parent, false)
        )
    }
