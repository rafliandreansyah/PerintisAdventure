...
class BookingTourViewModel : ViewModel(){
    ...
    fun booking(dateTour: Timestamp?, tourId: String?, partnerId: String?,
        ...
        userDb.add(detailBookingTourUser).addOnSuccessListener {
            ...
            bookingDataPartner(tourId, totalPrice, dateTour, pickupArea, partnerId, bookedTourId, tourName)
    ...
    private fun bookingDataPartner(tourId: String?, totalPrice: Long?, dateTour: Timestamp?, pickupArea: String?,
        ...
        partnerDb.add(dataBookingPartner).addOnSuccessListener {
            ...
            userListBooking(bookedTourId, partnerId, bookingDbTourPartnerId, tourName, totalPrice, dateTour)
        }.addOnFailureListener {
    ...
    private fun userListBooking(bookingTourId: String?, partnerId: String?, bookingDbTourPartnerId: String?,
    ...
    private fun updateDataListIdUser(partnerId: String?, bookingDbPartnerId: String?, idList: String?){
    ...
    private fun getIdListUserToPartner(partnerId: String?, bookingDbPartnerId: String?, idList: String?){
