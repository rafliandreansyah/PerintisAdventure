 ...
 * Use the [PerintisNewsDetailFragment.newInstance] factory method to
...
class PerintisNewsDetailFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PerintisNewsDetailFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PerintisNewsDetailFragment().apply {
