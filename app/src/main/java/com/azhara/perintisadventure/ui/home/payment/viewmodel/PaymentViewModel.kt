package com.azhara.perintisadventure.ui.home.payment.viewmodel
...
class PaymentViewModel : ViewModel() {
    ...
    fun uploadProofPayment(
        imgByteArray: ByteArray, partnerId: String?, bookingPartnerId: String?,
    ...
    private fun updateDataUsersUploadPayment(
        urlImgProofPayment: String?,
        ...
        userDb.update(dataUpdate).addOnSuccessListener {
            Log.d("Payment", "Berhasil upload")
            updateDataPartnersUploadPayment(
                urlImgProofPayment,
                partnerId,
                bookingPartnerId,
                bookingType
    ...
    private fun updateDataPartnersUploadPayment(
        urlImgProofPayment: String?,
        partnerId: String?,
        bookingPartnerId: String?,
        bookingType: Int?
